...
<div className="container mx-auto p-6 bg-white shadow-lg rounded-lg">
    ...
    <div className="flex justify-between mt-6">
        <button className="px-6 py-3 text-white bg-gray-700 hover:bg-gray-800 font-medium text-sm rounded shadow"
            onClick={()=> navigate("/")}
            >
            Back to Dashboard
        </button>
        {(authUser.role === "admin" || authUser.role === "superadmin") && (
        <button className="px-6 py-3 text-white bg-green-500 hover:bg-green-600 font-medium text-sm rounded shadow"
